      ...
      <?php 
            ...
            foreach($lista_usuarios as $key =>$values){
              if($values["alinhamento"] == "The_Boys"){
                ...
                echo $values["interprete"];
        
                echo "<br><strong>Idade</strong>: ";
                echo $values["idade"];
               
                echo "<br><strong>Alinhamento</strong>: ";
                echo $values["alinhamento"];
                
                echo "<br><strong>Biografia</strong>: ";
                echo $values['biografia'];
